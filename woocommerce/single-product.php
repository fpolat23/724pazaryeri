...
// YENİ KURAL: GÖRÜNÜR olan TÜM attribute'lar seçim butonu olarak göster (Hepsiburada tarzı)
    ...
    <div class="hb-buybox">
      ...
      ?>
      <div class="hb-share">
        <span class="hb-share-lbl">Bu ürünü paylaş:</span>
        <div class="hb-share-btns">
          <a class="hb-share-btn hb-share-wa" href="https://wa.me/?text=<?php echo $pz_share_title; ?>%20<?php echo $pz_share_url; ?>" target="_blank" rel="noopener" title="WhatsApp'ta Paylaş">
          ...
          <a class="hb-share-btn hb-share-fb" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $pz_share_url; ?>" target="_blank" rel="noopener" title="Facebook'ta Paylaş">
          ...
          <a class="hb-share-btn hb-share-tw" href="https://x.com/intent/tweet?text=<?php echo $pz_share_title; ?>&url=<?php echo $pz_share_url; ?>" target="_blank" rel="noopener" title="X'te Paylaş">
            <svg viewBox="0 0 24 24" width="15" height="15" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.253 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            <span>X</span>
          </a>
          <button class="hb-share-btn hb-share-ig" onclick="pzShareApp('instagram','<?php echo $pz_raw_url; ?>','<?php echo $pz_raw_title; ?>')" title="Instagram'da Paylaş">
          ...
          <button class="hb-share-btn hb-share-tt" onclick="pzShareApp('tiktok','<?php echo $pz_raw_url; ?>','<?php echo $pz_raw_title; ?>')" title="TikTok'ta Paylaş">
          ...
          <a class="hb-share-btn hb-share-pt" href="https://pinterest.com/pin/create/button/?url=<?php echo $pz_share_url; ?>&media=<?php echo $pz_share_img; ?>&description=<?php echo $pz_share_title; ?>" target="_blank" rel="noopener" title="Pinterest'te Paylaş">
          ...
          <a class="hb-share-btn hb-share-li" href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo $pz_share_url; ?>&title=<?php echo $pz_share_title; ?>" target="_blank" rel="noopener" title="LinkedIn'de Paylaş">
          ...
          <button class="hb-share-btn hb-share-copy" onclick="pzCopyLink('<?php echo $pz_raw_url; ?>')" title="Bağlantıyı Kopyala">
